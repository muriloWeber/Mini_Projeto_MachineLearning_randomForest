...
# Troque pela pasta do seu computador
setwd("H:/Meu Drive/Cursos/PowerBI-DataScience/Cap15-AnáliseDeDadosEMachineLearning")
getwd()

# Definição do problema
# Leio o manual em pdf com a definição do problema no diretório
...
# Visualizando ps dados e sua estrutura
View(dados_clientes)
dim(dados_clientes)
str(dados_clientes)
...
# se fosse necessário fazer transformação caso houvesse valores missing
# na.omit omite valores ausentes
dados_clientes <- na.omit(dados_clientes)

# Convertendo os atributos genero, escolaridade, estado civil e idade
# para fatores categoria
...
prop.table(table(dados_clientes$inadimplente)) * 100
...
install.packages("H:/Meu Drive/Cursos/PowerBI-DataScience/Cap15-AnáliseDeDadosEMachineLearning/DMwR_0.4.1.tar.gz")
file.exists("H:/Meu Drive/Cursos/PowerBI-DataScience/Cap15-AnáliseDeDadosEMachineLearning/DMwR_0.4.1.tar.gz")
install.packages( c("xts","quantmod") )
install.packages("abind")
install.packages("ROCR")
library(DMwR)
?SMOTE
# DMwR descontinuado, baixei arquivo antigo na pasta e instalei via Tools do RStudio
...
# Construindo a segunda versão do modelo, agora com os dados de treino balanceados
...
setwd("C:/Users/murilo.weber/Documents/Cap15")
